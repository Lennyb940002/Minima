...
export function DashboardCard({ title, Icon }: DashboardCardProps) {
  return (
    <div className="bg-black border border-white px-6 py-8 rounded-lg transition-all duration-300 hover:bg-white group cursor-pointer top-10 rounded-[25px]" style={{ width: '380px', height: '260px' }}>
